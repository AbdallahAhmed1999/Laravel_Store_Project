            ...
            <div class="container">
                ...
                >
                    <div class="mb-3 mb-md-0">
                        <h2>{{auth()->user()->name}} Delivered Orders</h2>
                    </div>
                    <div class="page_link">
                        <a href="{{route('home')}}">Home</a>
                        <a href="{{route('orders.history')}}">Delivered Orders</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-lg-4 mt-5">
                            <div class="order_box">
                                ...
                                <ul class="list list_2">
                                    ...
                                    <li>
                                        <a href="#">
                                            Status<span class="genric-btn success circle small mt-2">{{$order->status->name}}</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
